...
return function(GithubLoader, ScriptService)
    ...
    local src = game:HttpGet('https://raw.githubusercontent.com/1ForeverHD/TopbarPlus/refs/heads/main/src/init.lua'):gsub('localPlayer:WaitForChild%("PlayerGui"%)', 'game:GetService("CoreGui").MacFries.Guis'):gsub('require%(script.Types%)', '{}')
    ScriptService.makeModuleCache(TopbarPlus, src)
    ...
    ScriptService.makeModuleCache(TopbarPlus.Packages.Janitor, [====[--[[
-------------------------------------
...
Janitor.__index.addObject = Janitor.__index.AddObject
Janitor.__index.giveObject = Janitor.__index.GiveObject
...
Janitor.__index.remove = Janitor.__index.Remove
...
Janitor.__index.get = Janitor.__index.Get
...
Janitor.__index.cleanup = Janitor.__index.Cleanup
Janitor.__index.Clean = Janitor.__index.Cleanup
Janitor.__index.clean = Janitor.__index.Clean
